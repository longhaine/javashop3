...
<%
	ArrayList<Products> popularProductList = (ArrayList<Products>) request.getAttribute("popularProductList");
            ...
            <div class="row">
                <div class="col-12">
                    <div class="popular-products-slides owl-carousel">
						<%
						for(Products product : popularProductList)
						{
                            ...
                            <div class="product-description">
                                ...
                                <div class="hover-content">
                                    ...
                                    <div class="add-to-cart-btn">
                                        <a href="#" onclick="addCart(<%=id%>,'<%=name%>','<%=price%>','<%=image%>1.jpg','<%=brand%>')" class="btn essence-btn">Add to Cart</a>
                                    </div>
                                </div>
                            </div>
                        </div>
